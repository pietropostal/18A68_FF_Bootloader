...
#ifdef ECC_USE_COMPRESSED
int ecdsa_verify_compressed(const uint8_t p_publicKey[ECC_BYTES+1], const uint8_t p_hash[ECC_BYTES], const uint8_t p_signature[ECC_BYTES*2])
{
...
int ecdsa_verify(const uint8_t p_publicKey[ECC_BYTES*2], const uint8_t p_hash[ECC_BYTES], const uint8_t p_signature[ECC_BYTES*2])
{
    ...
    //ecc_point_decompress(&l_public, p_publicKey);
     ...
     ecc_bytes2native( l_public.x, &p_publicKey[0] ) ;
